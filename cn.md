...
<details open> <summary>展开</summary>
  ...
  - 请修复在椅子上坐下时与聆听歌姬献唱时，退出键错误的设置为手柄右键（PS○、Xbox B、NS A）与鼠标右键的问题。
...
<details open> <summary>展开</summary>
  ...
  - 请追加在道具袋界面从道具袋选择两种道具调合的功能，并将原有的调和修改为“调合此道具”。
